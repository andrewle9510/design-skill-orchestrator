...
description: Expert skill for spacing systems, layout grids, responsive breakpoints, and whitespace design. Use when defining spacing scales, implementing grid systems, setting up responsive layouts, or establishing consistent padding/margin patterns.
---
