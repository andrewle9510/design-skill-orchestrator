---
name: fd-patterns
description: Expert skill for page compositions, common UI patterns, navigation structures, and user flows. Use for full page designs, layout templates, navigation patterns, or form flows.
---
